...
const IdProduct = () => {
    ...
    const remove = async (id) => {
        const {error} = await fetch(`${baseURL}/product/${id}`, { method: "delete" });
       // const data = await res.json();
    ...
    const Columns = [
        ...
        { field: 'title', headerName: "Tiêu đề sản phẩm", width: 200, editable: true },
                                ...
                                <div className="row" >
                                    <div  >
                                        <div className="form-group ">
                                            ...
                                            <input type="text" className="form-control " ref={post_name}>
                                            </input>
                                        </div>

                                        <div className="form-group " style={{ marginTop: 20 }}>
                                            <label className="required">Nhập tiêu đề sản phẩm </label>
                                            <input type="text" className="form-control " ref={post_title}></input>
                                        </div>
