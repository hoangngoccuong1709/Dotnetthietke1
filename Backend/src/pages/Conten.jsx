...
const IdConten = () => {
    ...
    const remove = async (id) => {
        const {error} = await fetch(`${baseURL}/conten/${id}`, { method: "delete" });
    ...
    const Columns = [
        ...
        { field: 'nameConten', headerName: "Tên bài viết", width: 200, editable: true },
        { field: 'title', headerName: "Tiêu đề bài viết", width: 200, editable: true },
        { field: 'pharagraph', headerName: "Nội dung bài viết", width: 300, editable: true },
        { field: 'posion', headerName: "Vị trí bài viết", width: 100, editable: true },
        { field: 'imageconten', headerName: "Hình ảnh bài viết", width: 100, editable: true }];
                                ...
                                <div className="row" >
                                    <div  >
                                        ...
                                        <div className="form-group " style={{ marginTop: 20 }}>
                                            ...
                                            <input type="text" className="form-control " ref={post_title} required pattern="\S+"></input>
                                        </div>

                                        <div className="form-group " style={{ marginTop: 20 }}>
                                            <label className="required">Nhập nội dung bài viết</label>
                                            <input type="text" className="form-control " ref={post_paragraph} required pattern="\S+"></input>
                                        </div>
                                        <select id="cars" style={{ marginTop: 20 }}ref={post_posion} >
                                        ...
                                        <div className="form-group " style={{ marginTop: 20 }}>
                                            ...
                                            <input type="text" className="form-control " ref={post_imageconten}required pattern="\S+" ></input>
                                        </div>
                                    </div>
