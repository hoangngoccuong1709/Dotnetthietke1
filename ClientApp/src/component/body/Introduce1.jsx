...
export default function Introduce1() {
  return (
    ...
    <img className="gioithieu1hoa" src="image/Leaf7.png " style={{position: 'absolute', right: 0, marginTop: '-3rem'}} /> 
    ...
    </div> <img className="imggt2" src="image/Leaf8.png " style={{position: 'absolute', left: 0}} />
    <div className="gioithieu3">
        ...
        <img className="hoa3" src="image/Leaf7.png " style={{position: 'absolute', right: 0, marginTop: '-5rem'}} />
    </div>
