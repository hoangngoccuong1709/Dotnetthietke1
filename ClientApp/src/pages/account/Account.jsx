            ...
            <div className="row" >
               <div>
                    ...
                    <div className="form-group " style={{ marginTop: 20 }}>
                        ...
                        <label type="text" className="form-control " required pattern="\S+">{user.account.userName} </label>
                    </div>
                    <div className="form-group " style={{ marginTop: 20 }}>
                        <label className="required"> Số điện thoại :  </label>
                        <label type="text" className="form-control " required pattern="\S+">{user.account.email} </label>
                    </div>
